...
Модуль **Общение** - это мощный инструмент с простым интерфейсом. Окно взаимодействия чата
...
Обмен файлами
-------------
Модули чат позволяет обмениваться файлами и изображениями разного формата. Для отправки нескольких файлов одновременно,
